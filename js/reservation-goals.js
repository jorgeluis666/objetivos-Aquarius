(function () {
  ...
  async function init() {
    if (!document.getElementById('reservation-goal-style')) {
      ...
      style.textContent = '.reservation-value{display:block}.reservation-trend{display:block;margin-top:2px;font-size:18px;font-weight:900;line-height:1}.reservation-trend.up{color:#16a34a}.reservation-trend.down{color:#dc2626}';
